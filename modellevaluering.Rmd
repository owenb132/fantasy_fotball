...
data_df = read.csv2("data/teamdata_2017-04-04.csv",stringsAsFactors = FALSE)
```
...
kable(filter(data_df,player_name=="Eivind Hageberg"))
```


```{r,echo=F}
#plotter poengtotal, med vline på min poengsum
qplot(total,data=data_df)+
        geom_vline(xintercept = filter(data_df,player_name=="Eivind Hageberg")$total)
...
df_spillerdata = fromJSON(content(spillerdata,"text"))
